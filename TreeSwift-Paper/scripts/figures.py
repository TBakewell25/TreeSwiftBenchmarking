...
T = ['DendroPy','Bio.Phylo','ETE Toolkit','TreeSwift', 'CompactTree']
name_to_key = {'DendroPy':'dendropy', 'Bio.Phylo':'biophylo', 'TreeSwift':'treeswift', 'ETE Toolkit':'ete3', 'CompactTree':'compacttree'}
pal = {'TreeSwift':'black', 'Bio.Phylo':'red', 'DendroPy':'blue', 'ETE Toolkit':'green', 'CompactTree':'purple'}
linestyle = {'TreeSwift':'-', 'DendroPy':':', 'Bio.Phylo':'--', 'ETE Toolkit':'-.', 'CompactTree':'-.'}
meta = {
    'name': {
